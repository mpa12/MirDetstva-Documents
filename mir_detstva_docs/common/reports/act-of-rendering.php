...
<table>
    ...
    <tr style="padding: 0; border: 1px solid black; font-size: 11px">
        <td style="width: 25px"></td>
        <td colspan="31" style="font-size: 19px; font-weight: bold; border-bottom: 2px solid black">Акт № <?= $model->number ?> от <?= $model->fromDateText ?></td>
        <td style="width: 25px"></td>
    </tr>
